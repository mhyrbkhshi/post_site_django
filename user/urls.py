...
from .views import UserLogoutView, UserSigninView, UserSignupView, UserProfileView, UserEditView, create_otp_view, check_otp_view, UpdatePassView

urlpatterns = [
    path('logout/', UserLogoutView.as_view(), name='user-logout'),
    path('signin/', UserSigninView.as_view(), name='user-signin'),
    path('signup/', UserSignupView.as_view(), name='user-signup'),
    path('profile/changepass', UpdatePassView.as_view(), name='user-password'),
